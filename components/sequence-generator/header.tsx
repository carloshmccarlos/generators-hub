    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm font-medium text-[#6b6b6b]">5 modes · Charts · CSV export</p>
        </div>
      </div>
      <p className="max-w-xl text-[15px] leading-relaxed text-[#6b6b6b]">
        <span className="font-semibold text-[#1c1c1c]">Generate number sequences.</span>{" "}
        Arithmetic, geometric, Fibonacci, random, or formula-based.
      </p>
    </motion.div>
  );
}
